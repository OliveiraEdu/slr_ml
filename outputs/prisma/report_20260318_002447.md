...
This systematic review identified **79 studies** meeting inclusion criteria.
...
| Screened | 498 | 100% |
| Excluded at title/abstract | 422 | 84.7% |
| Assessed for full-text | 79 | 15.9% |
| Excluded at full-text | 0 | 0.0% |
| **Studies included** | **79** | **15.9%** |
...
flowchart TD
    ...
    C --> D[Excluded by Title/Abstract<br/>n=422]
    D --> E[Records Eligible<br/>n=79]
    E --> F[Full-Text Assessed<br/>n=79]
    F --> G[Excluded Full-Text<br/>n=0]
    G --> H[Studies Included<br/>n=79]
    style A fill:#e1f5fe
    style C fill:#fff3e0
    style F fill:#fff3e0
    style H fill:#e8f5e9
...
| Not specified | 69 |
| Ethereum | 8 |
| Hyperledger; Ethereum | 1 |
| Hyperledger Fabric; Hyperledger | 1 |
---
...
| Good | Score 4 - minor methodological gaps | 5 |
| Acceptable | Score 3 - some concerns | 17 |
| Poor | Score 2 - significant gaps | 28 |
| Very_poor | Score 1 - cannot assess | 28 |

**Mean Quality Score:** 0.21 / 1.0

### 4.2 MMAT Item Scores

| MMAT Item | Yes | Can't tell | Rate |
|-----------|-----|------------|------|
| Clear Research Questions | 12 | 67 | 15.2% |
| Appropriate Methodology | 33 | 46 | 41.8% |
| Rigorous Data Collection | 5 | 74 | 6.3% |
| Sound Analysis | 29 | 50 | 36.7% |
| Well-supported Conclusions | 2 | 77 | 2.5% |
---
...
| REV072 | Retracted: Healthcare and Fitness Data Management ... | 2023 | Healthcare Engineering JO. | ieee |
| REV073 | ACTION-EHR: Patient-Centric Blockchain-Based Elect... | 2020 | Dubovitskaya A, Baig F, Xu Z | ieee |
| REV074 | Retrieval Integrity Verification and Multi-System ... | 2024 | Zhou Z, Chen L, Zhao Y | ieee |
| REV075 | Under lock and key: Incorporation of blockchain te... | 2022 | Ramesh PV, Devadas AK, Ray P | ieee |
| REV076 | A Permissioned Blockchain Network for Security and... | 2020 | Lima VC, Bernardi FA, Alves D | ieee |
| REV077 | Food Safety Distribution Systems Using Private Blo... | 2025 | Oh SE, Kim JH, Kim JY | ieee |
| REV078 | A systematic study on blockchain technology for ge... | 2026 | Arya A, Malik A. | ieee |
| REV079 | Validation and user experience testing of DataCryp... | 2025 | Franc JM. | ieee |
---
